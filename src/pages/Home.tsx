        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          <div>
            <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight drop-shadow-lg">
              <span className="gradient-text-primary enhanced-glow entrance-slide-left">Welcome to</span>
              <span className="block gradient-text-accent font-extrabold enhanced-glow entrance-slide-right stagger-1">MPC Youth Fellowship</span>
            </h1>
